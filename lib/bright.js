var brightJs = (function () {
  ...
  function lastChild() {
      // @ts-expect-error
      return this.herit.apply(this, _to_consumable_array$4(this.nodes.map(function(node) {
  ...
  function addClass() {
      ...
      return this.each(function(node) {
          var // @ts-expect-error
          _node_classList;
          (_node_classList = node.classList).add.apply(_node_classList, _to_consumable_array$3(classNames));
      });
  }
  function removeClass() {
      ...
      return this.each(function(node) {
          var // @ts-expect-error
          _node_classList;
          (_node_classList = node.classList).remove.apply(_node_classList, _to_consumable_array$3(classNames));
      });
  }
  ...
  function filter(fn) {
      return this.herit.apply(this, _to_consumable_array$2(this.nodes.filter(fn)));
  }
